...
|---------|-----------|-------------|
| **Tailscale Exit Node** | CT100 | VPN gateway with TUN/TAP passthrough in an unprivileged container |
| **Jellyfin** | CT101 | Media streaming server with bind-mounted access to the shared storage pool |
| **Samba** | CT102 | SMB file sharing for LAN devices (guest access for home use) |
| **Pi-hole** | Nepal Pi | Network-wide DNS filtering |
...
<p align="center">
  <img src="images/LXC%20list.png" alt="LXC Container List" width="700">
</p>
